...
public class Game
{
  ...
  public Game(String aName, int aPrice, String aDescription, Category aCategory, GameConsole aGameConsole, int aId, Catalog aCatalog)
  {
    name = aName;
    price = aPrice;
    ...
    if (!didAddCatalog)
    {
      throw new RuntimeException("Unable to create game due to catalog. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
    }
  }
  ...
  /* Code from template association_AddManyToOne */
  public Review addReview(Date aDate, String aDescription, int aLikeCount, int aDislikeCount, float aRating, boolean aEmployeeReviewed, int aId, CustomerAccount aCustomerAccount)
  {
    return new Review(aDate, aDescription, aLikeCount, aDislikeCount, aRating, aEmployeeReviewed, aId, aCustomerAccount, this);
  }
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "gameConsole" + "=" + (getGameConsole() != null ? !getGameConsole().equals(this)  ? getGameConsole().toString().replaceAll("  ","    ") : "this" : "null") + System.getProperties().getProperty("line.separator") +
