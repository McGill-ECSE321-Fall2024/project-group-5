...
public class AccountIntegrationTests {
    ...
    public void testCreateValidAccount() {
        /*
         * // Arrange
         * AccountRequestDto request = new AccountRequestDto(VALID_NAME, VALID_EMAIL,
         * VALID_PASSWORD);
         * 
         * // Act
         * ResponseEntity<AccountResponseDto> response = client.postForEntity("/people",
         * request, AccountResponseDto.class);
         * 
         * // Assert
         * assertNotNull(response);
         * assertEquals(HttpStatus.CREATED, response.getStatusCode());
         * AccountResponseDto createdAccount = response.getBody();
         * assertNotNull(createdAccount);
         * assertEquals(VALID_NAME, createdAccount.getName());
         * assertEquals(VALID_EMAIL, createdAccount.getEmail());
    ...
    @Test
    @Order(2)
    public void testReadAccountByValidId() {
        /*
         * // Arrange
         * String url = "/people/" + this.validId;
         * 
         * // Act
         * ResponseEntity<AccountResponseDto> response = client.getForEntity(url,
         * AccountResponseDto.class);
         * 
         * // Assert
         * assertNotNull(response);
         * assertEquals(HttpStatus.OK, response.getStatusCode());
         * AccountResponseDto person = response.getBody();
