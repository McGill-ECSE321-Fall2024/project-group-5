...
public class CustomerAccountIntegrationTests {
    ...
    private static final String UPDATE_CUSTOMER_ACCOUNT_URL = CUSTOMER_ACCOUNT_API_URL + "update/{id}";
    private static final String DELETE_CUSTOMER_ACCOUNT_URL = CUSTOMER_ACCOUNT_API_URL + "delete/{id}";
    private static final String GET_ALL_CUSTOMER_ACCOUNTS_URL = CUSTOMER_ACCOUNT_API_URL + "get";
    private static final String GET_CUSTOMER_ACCOUNT_BY_EMAIL_URL = CUSTOMER_ACCOUNT_API_URL + "getWithEmail/{email}";
    ...
    public void testCreateValidCustomerAccount() {
        ...
        ResponseEntity<CustomerAccountResponseDto> response = customer.postForEntity(CREATE_CUSTOMER_ACCOUNT_URL,
        ...
        assertEquals(VALID_USERNAME, createdCustomerAccount.getUsername(), "Username should match input username");
    ...
    public void testCreateCustomerAccountWithInvalidEmail() {
        ...
        // Act: Send POST request to create the account
        ResponseEntity<String> response = customer.postForEntity(CREATE_CUSTOMER_ACCOUNT_URL, request, String.class);
    ...
    public void testUpdateCustomerAccount() {
        ...
        ResponseEntity<CustomerAccountResponseDto> response = customer.getForEntity(GET_CUSTOMER_ACCOUNT_URL + validId,
                CustomerAccountResponseDto.class);
    ...
    public void testDeleteCustomerAccount() {
        ...
        ResponseEntity<String> response = customer.getForEntity(GET_CUSTOMER_ACCOUNT_URL + validId, String.class);
