...
//         GameResponseDto createdGame = response.getBody();
//         assertNotNull(createdGame, "Response body should not be null");
//         assertEquals(VALID_NAME, createdGame.getName(), "Game name should match the expected name");
//         assertEquals(VALID_CATEGORY.name(), createdGame.getCategory(), "Game category should match the expected category");
//         assertEquals(VALID_GAME_CONSOLE.name(), createdGame.getGameConsole(), "Game console should match the expected console");
//         assertEquals(VALID_PRICE, createdGame.getPrice(), "Game price should match the expected price");
//         assertEquals(VALID_DESCRIPTION, createdGame.getDescription(), "Game description should match the expected description");
//         assertEquals(VALID_IN_CATALOG, createdGame.isInCatalog(), "Game catalog status should match the expected status");
    
//         // Ensure ID is properly assigned
//         assertNotNull(createdGame.getId(), "Game ID should be set after creation");
//         assertTrue(createdGame.getId() > 0, "Game ID should be positive");
    
//         // Save the game ID for use in subsequent tests
//         this.validId = createdGame.getId();
//     }
