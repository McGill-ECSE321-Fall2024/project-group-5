...
public class CustomerAccountRepositoryTest {
	...
	public void testSaveAndFindById() {
		...
		account.setEmailAddress("testuser@example.com");
	...
	public void testFindByEmailAddress() {
		...
		CustomerAccount account = new CustomerAccount();
		account.setEmailAddress("findme@example.com");
	...
	public void testUpdateCustomerAccount() {
		// Create and save a customer account
		CustomerAccount account = new CustomerAccount();
		account.setEmailAddress("update@example.com");
		...
		CustomerAccount updatedAccount = customerAccountRepository.findById(foundAccount.getId()).orElse(null);
	...
	public void testDeleteCustomerAccount() {
		// Create and save a customer account
		CustomerAccount account = new CustomerAccount();
		account.setEmailAddress("delete@example.com");
